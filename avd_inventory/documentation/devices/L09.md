...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | oob_management | oob | MGMT | 192.168.0.109/24 | 192.168.0.1 |
...
| --------- | --------------- | ------------ | --------- |
| pod4 | Vlan4094 | 10.255.252.17 | Port-Channel31 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet11 | L2L09_Ethernet11 | *trunk | *none | *- | *- | 11 |
| Ethernet12 | L2L10_Ethernet11 | *trunk | *none | *- | *- | 12 |
| Ethernet31 | MLAG_PEER_L10_Ethernet31 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 31 |
| Ethernet32 | MLAG_PEER_L10_Ethernet32 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 31 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet21 | P2P_LINK_TO_S01_Ethernet9 | routed | - | 172.30.255.65/31 | default | 9214 | False | - | - |
| Ethernet22 | P2P_LINK_TO_S02_Ethernet9 | routed | - | 172.30.255.67/31 | default | 9214 | False | - | - |
| Ethernet23 | P2P_LINK_TO_S03_Ethernet9 | routed | - | 172.30.255.69/31 | default | 9214 | False | - | - |
| Ethernet24 | P2P_LINK_TO_S04_Ethernet9 | routed | - | 172.30.255.71/31 | default | 9214 | False | - | - |
...
interface Ethernet11
   description L2L09_Ethernet11
   no shutdown
   channel-group 11 mode active
!
interface Ethernet12
   description L2L10_Ethernet11
   no shutdown
...
| Port-Channel31 | MLAG_PEER_L10_Po31 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 192.0.255.11/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 192.0.254.11/32 |
| Loopback100 | TEST_VRF_VTEP_DIAGNOSTICS | TEST_VRF | 10.255.1.11/32 |
...
| Vlan3009 |  TEST_VRF  |  10.255.251.16/31  |  -  |  -  |  -  |  -  |  -  |
...
| 172.30.255.64 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 172.30.255.66 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 172.30.255.68 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 172.30.255.70 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
| 10.255.251.17 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | TEST_VRF | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 100 | 192.0.255.11:10100 | 10100:10100 | - | - | learned |
| 150 | 192.0.255.11:10150 | 10150:10150 | - | - | learned |
| 200 | 192.0.255.11:10200 | 10200:10200 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| TEST_VRF | 192.0.255.11:10 | connected |
...
router bgp 65105
   ...
   !
   vlan 100
      rd 192.0.255.11:10100
      route-target both 10100:10100
      redistribute learned
   !
   vlan 150
      rd 192.0.255.11:10150
      route-target both 10150:10150
      redistribute learned
   !
   vlan 200
      rd 192.0.255.11:10200
